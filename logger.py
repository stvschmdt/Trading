...
#TODO add filepath handling from sys
    ...
    def buy(self, msg):
        print "[buy] {}".format(datetime.datetime.utcnow()), msg

    def sell(self, msg):
        print "[sell] {}".format(datetime.datetime.utcnow()), msg

    def profit(self, msg):
        print "[profit] {}".format(datetime.datetime.utcnow()), msg

    def loss(self, msg):
        print "[loss] {}".format(datetime.datetime.utcnow()), msg
